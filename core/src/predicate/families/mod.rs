...
mod name_length_max;
mod name_length_min;
mod name_word_count_eq;
mod name_word_count_max;
mod name_word_count_min;
mod numeric_between;
mod numeric_gte;
mod numeric_lte;
...
pub fn register_defaults(registry: &mut PredicateRegistry) {
    ...
    registry.register(name_word_count_eq::Factory);
    registry.register(name_word_count_min::Factory);
    registry.register(name_word_count_max::Factory);
